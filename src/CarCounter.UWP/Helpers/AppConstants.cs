...
namespace CarCounter.UWP.Helpers
{
    ...
    {
        public static string Cctv1 { set; get; } = "rtsp://demo:demo@ipvmdemo.dyndns.org:5541/onvif-media/media.amp?profile=profile_1_h264&sessiontimeout=60&streamtype=unicast";
